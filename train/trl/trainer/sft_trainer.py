...
class SFTTrainer(Trainer):
    ...
    def _prepare_dataset(
        ...
        with PartialState().local_main_process_first():
            ...
            if not is_processed:
                ...
                def tokenize(ex):
                    # tokenized = processing_class(ex[args.dataset_text_field]) # would add two bos for llama3
                    tokenized = processing_class(ex[args.dataset_text_field], add_special_tokens=False)
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        """
        # print('inputs for loss computation:', inputs)
